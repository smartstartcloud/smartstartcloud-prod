...
import { getPaymentDetails, getPaymentDetailsByType, updatePaymentDetails } from "../controllers/payment.controller.js";
...
router.get("/getPaymentData/all", getPaymentDetailsByType);
